...
![Catch date and the total number (n) of juvenile brown trout sampled from each location each year.](outputs/Sample_site_overview.png){#tbl-sites}

![Mean (g/g), standard deviation, and relative standard deviation of the reference materials NIST612 and MACS3. * The three selected elements.](outputs/NIST_MACS_values.png){#tbl-reference-material}
